...
int main(int argc,char* argv[])
{
  ...
  34:	7c050513          	addi	a0,a0,1984 # 7f0 <malloc+0xe8>
  38:	00000097          	auipc	ra,0x0
  3c:	612080e7          	jalr	1554(ra) # 64a <printf>
    exit(1);
  40:	4505                	li	a0,1
  42:	00000097          	auipc	ra,0x0
  46:	290080e7          	jalr	656(ra) # 2d2 <exit>
    printf("sleep error");
  4a:	00000517          	auipc	a0,0x0
  4e:	7b650513          	addi	a0,a0,1974 # 800 <malloc+0xf8>
  52:	00000097          	auipc	ra,0x0
  56:	5f8080e7          	jalr	1528(ra) # 64a <printf>
...
free(void *ap)
{
 ...
 68e:	1a67b783          	ld	a5,422(a5) # 830 <freep>
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x50>
{
 ...
 6fe:	12f73b23          	sd	a5,310(a4) # 830 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	10453503          	ld	a0,260(a0) # 830 <freep>
 ...
 758:	0dc90913          	addi	s2,s2,220 # 830 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 75e:	a88d                	j	7d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 760:	00000797          	auipc	a5,0x0
 764:	0d878793          	addi	a5,a5,216 # 838 <base>
 768:	00000717          	auipc	a4,0x0
 76c:	0cf73423          	sd	a5,200(a4) # 830 <freep>
 770:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 792:	0aa73123          	sd	a0,162(a4) # 830 <freep>
      return (void*)(p + 1);
